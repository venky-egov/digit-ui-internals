      ...
      },
      {
        ...
        values: [
          ...
          },
          {
            ...
            value: application.pitDetail.distanceFromRoad !== 0 ? `${application.pitDetail.distanceFromRoad}m` : "NA" || "NA",
          },
          ...
          { title: "Total Amount Due", value: application?.amountDue && application?.amountDue !== 0 ? `₹ ${application.amountDue}` : "NA" || "NA" },
        ],
      },
    ],
  };
