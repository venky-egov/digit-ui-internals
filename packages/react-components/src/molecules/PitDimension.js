...
const PitDimension = ({ sanitationType, t, size = {}, handleChange, disable = false }) => {
  ...
  return sanitationType?.dimension === "dd" ? (
    <div className="inputWrapper">
      <div>
        <TextInput name="diameter" value={size["diameter"] || ""} onChange={handleChange} disable={disable} />
      ...
      <span>x</span>
      <div>
        <TextInput name="height" value={size["height"] || ""} onChange={handleChange} disable={disable} />
        <CardText style={{ textAlign: "center" }} disable={disable}>
    ...
    <div className="inputWrapper">
      <div>
        <TextInput name="length" value={size["length"] || ""} onChange={handleChange} disable={disable} />
        <CardText style={{ textAlign: "center" }} disable={disable}>
      ...
      <span>x</span>
      <div>
        <TextInput name="width" value={size["width"] || ""} onChange={handleChange} disable={disable} />
        <CardText style={{ textAlign: "center" }} disable={disable}>
